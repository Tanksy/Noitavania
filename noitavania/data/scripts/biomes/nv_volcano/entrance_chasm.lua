...
function init(x, y, w, h)
  LoadPixelScene("mods/noitavania/data/scenes/nv_volcano/volcano/5_left.png", "", x - 69, y - 52, "", true)
  LoadPixelScene("mods/noitavania/data/scenes/nv_volcano/volcano/5_right.png", "", x + 511, y - 52, "", true)
end
