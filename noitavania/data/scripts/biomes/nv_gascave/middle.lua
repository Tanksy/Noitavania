...
function init( x, y, w, h )
	LoadPixelScene( "mods/noitavania/data/scenes/nv_gascave/middle.png", "", x, y, "", true )
	LoadPixelScene( "mods/noitavania/data/scenes/nv_gascave/entrance.png", "", x, y +512, "", true )
end