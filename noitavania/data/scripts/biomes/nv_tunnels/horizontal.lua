...
function init(x, y, w, h)
	LoadPixelScene( "mods/noitavania/data/scenes/nv_tunnels/horizontal.png", "", x, y, "", true )
	LoadPixelScene( "mods/noitavania/data/scenes/nv_tunnels/horiz_left.png", "", x-512, y, "", true )
	LoadPixelScene( "mods/noitavania/data/scenes/nv_tunnels/horiz_right.png", "", x+512, y, "", true )
end
