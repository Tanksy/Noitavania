...
function init(x, y, w, h)
	LoadPixelScene( "mods/noitavania/data/scenes/nv_tunnels/horiz_left.png", "", x-562, y, "", true )
	LoadPixelScene( "mods/noitavania/data/scenes/nv_secretshop/cavern_right.png", "mods/noitavania/data/scenes/nv_secretshop/cavern_right_visual.png", x-50, y, "mods/noitavania/data/scenes/nv_secretshop/cavern_right_background.png", true )
end
