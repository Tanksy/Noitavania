...
function init(x, y, w, h)
	LoadPixelScene( "mods/noitavania/data/scenes/nv_tunnels/horiz_right.png", "", x+562, y, "", true )
	LoadPixelScene( "mods/noitavania/data/scenes/nv_secretshop/cavern_left.png", "mods/noitavania/data/scenes/nv_secretshop/cavern_left_visual.png", x+50, y, "mods/noitavania/data/scenes/nv_secretshop/cavern_left_background.png", true )
end
