...
g_fungi =
{
	...
	-- add skullflys after this step
	{
		...
		min_count	= 1,
		max_count	= 1,    
		entity 	= "mods/noitavania/data/entities/sewer/drain_pipe_spawner.xml"
	},
...
g_props =
{
	...
	},
	{
		...
		max_count	= 1,    
		offset_y 	= 0,
		entity 	= "data/entities/props/physics_sandbag.xml"
	},
	{
		prob   		= 0.03,
		min_count	= 1,
	...
	},
	{
		...
		max_count	= 1,    
		offset_y 	= 0,
		entity 	= "data/entities/props/physics_barrel_burning.xml"
	},
{
		prob   		= 0.03,
		min_count	= 1,
